...
const weddingData = {
  ...
  // Section02 데이터
  bodyText: {
    guest: `소중한 인연으로 만난 황승현과 김정민이 이제 서로의 든든한 동반자가 되려 합니다.
...
소중한 마음으로 축복해 주시는 만큼 행복하게 잘 살겠습니다.`,
                nonGuest: `소중한 인연으로 만난 황승현과 김정민이 이제 서로의 든든한 동반자가 되려 합니다.

양가 직계 가족만 모시고 사랑과 약속에 집중하는 작은 예식을 올립니다.
모든 분을 모시지 못하는 점, 너그러이 양해 부탁드립니다.
멀리서나마 저희 두 사람의 앞날을 축복해주시면 행복하게 잘 사는 모습으로 보답하겠습니다.
감사합니다.`
  },
