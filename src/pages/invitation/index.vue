...
const weddingData = {
  ...
  bodyText: {
    guest: `안녕하세요.
            ...
            감사의 마음을 담아 모든 분들을 모시고 결혼식을 하여야 마땅하나
            양가 직계 가족 분들만을 모시고 간소한 예식을 올리기로 하였습니다.

            직접 찾아뵙고 결혼 소식을 전해드리지 못해
            송구스러운 마음입니다.
            많은 분을 정성껏 모시지 못하는 점 너그러이
            양해 해 주시면 감사하겠습니다다.            

            멀리서나마 저희 저희 두 사람의 앞날을 마음으로 축복해 주시면
