...
const weddingData = {
  ...
  bodyText: {
    guest: `안녕하세요.
            ...
            소중한 인연으로 만난 저희 두 사람이 이제 서로의 든든한
            동반자가 되어 서로를 존중하고 함께 사랑하고자 합니다.

            저희는 양가 가족과 가장 가까운 분들을 모신,
            두 사람의 진실한 사랑과 약속에 집중하는 작은 예식을
            올리게 되었습니다.

            화려함 보다는 서로에 대한 믿음과 배려를 약속하며,
            따뜻한 마음으로 첫걸음을 내딛으려 합니다.

            함께해 주시는 분들의 따뜻한 마음으로 배려를 양해하며,
            따뜻한 마음으로 축복해 주시면 더없는 기쁨이겠습니다.
            소중한 마음으로 축복해 주시는 만큼 행복하게 잘 살겠습니다.`,
                nonGuest: `안녕하세요.
            신랑 황승현과 신부 김정민이 서로의 인연을 귀하게 이어
            새로운 가정을 이루게 되었음을 알려드립니다.

            마땅히 많은 분들을 모시고 감사의 인사를 드려야 하나,
            양가 직계 가족만 함께하는 작은 예식으로 대신하게 되었습니다.

            직접 찾아뵙고 소식을 전하지 못해 송구스러운 마음이며,
            정성껏 모시지 못하는 점 너그러이 양해해 주시면 감사하겠습니다.

            멀리서나마 저희 두 사람의 앞날을 마음으로 축복해 주신다면
            더없는 기쁨으로 예쁘게 살아가겠습니다.
            늘 건강하시고 가정에 행복이 가득하시길 기원드립니다.`
  },
